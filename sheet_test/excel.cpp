...
LPDISPATCH _Application::GetFileExportConverters()
{
	LPDISPATCH result;
...
LPDISPATCH _Application::GetAddIns2()
{
	LPDISPATCH result;
...
BOOL _Application::GetPrintCommunication()
{
	BOOL result;
...
void _Application::SetPrintCommunication(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL _Application::GetUseClusterConnector()
{
	BOOL result;
...
void _Application::SetUseClusterConnector(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
CString _Application::GetClusterConnector()
{
	CString result;
...
void _Application::SetClusterConnector(LPCTSTR lpszNewValue)
{
	static BYTE parms[] =
		VTS_BSTR;
...
VARIANT _Application::GetHinstancePtr()
{
	VARIANT result;
...
long _Application::GetFileValidationPivot()
{
	long result;
...
void _Application::SetFileValidationPivot(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
BOOL _Application::GetShowQuickAnalysis()
{
	BOOL result;
...
void _Application::SetShowQuickAnalysis(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
	InvokeHelper(0xbb2, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
		 bNewValue);
}

LPDISPATCH _Application::GetQuickAnalysis()
{
	LPDISPATCH result;
...
BOOL _Application::GetFlashFill()
{
	BOOL result;
...
void _Application::SetFlashFill(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
	InvokeHelper(0xbb4, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
		 bNewValue);
}

BOOL _Application::GetEnableMacroAnimations()
{
	BOOL result;
...
void _Application::SetEnableMacroAnimations(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
	InvokeHelper(0xbb5, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
		 bNewValue);
}

BOOL _Application::GetChartDataPointTrack()
{
	BOOL result;
...
void _Application::SetChartDataPointTrack(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
	InvokeHelper(0xbb6, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
		 bNewValue);
}

BOOL _Application::GetFlashFillMode()
{
	BOOL result;
...
void _Application::SetFlashFillMode(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
	InvokeHelper(0xbb7, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
		 bNewValue);
}

BOOL _Application::GetMergeInstances()
{
	BOOL result;
...
void _Application::SetMergeInstances(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
	InvokeHelper(0xbb8, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
		 bNewValue);
}

BOOL _Application::GetEnableCheckFileExtensions()
{
	BOOL result;
...
void _Application::SetEnableCheckFileExtensions(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
	InvokeHelper(0xc56, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
		 bNewValue);
}
...
BOOL _Workbook::GetCaseSensitive()
{
	BOOL result;
...
BOOL _Workbook::GetUseWholeCellCriteria()
{
	BOOL result;
...
BOOL _Workbook::GetUseWildcards()
{
	BOOL result;
...
LPDISPATCH _Workbook::GetPivotTables()
{
	LPDISPATCH result;
...
BOOL _Workbook::GetChartDataPointTrack()
{
	BOOL result;
	InvokeHelper(0xbb6, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
	return result;
...
void _Workbook::SetChartDataPointTrack(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
	InvokeHelper(0xbb6, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
...
VARIANT _Workbook::GetDefaultTimelineStyle()
{
	VARIANT result;
...
void _Workbook::SetDefaultTimelineStyle(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
	InvokeHelper(0xbf4, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
		 &newValue);
}

LPDISPATCH _Workbook::GetQueries()
{
	LPDISPATCH result;
...
void _Workbook::CreateForecastSheet(LPDISPATCH Timeline, LPDISPATCH Values, const VARIANT& ForecastStart, const VARIANT& ForecastEnd, const VARIANT& ConfInt, const VARIANT& Seasonality, const VARIANT& DataCompletion, const VARIANT& Aggregation, 
		const VARIANT& ChartType, const VARIANT& ShowStatsTable)
{
	static BYTE parms[] =
		VTS_DISPATCH VTS_DISPATCH VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
	InvokeHelper(0xc5f, DISPATCH_METHOD, VT_EMPTY, NULL, parms,
		 Timeline, Values, &ForecastStart, &ForecastEnd, &ConfInt, &Seasonality, &DataCompletion, &Aggregation, &ChartType, &ShowStatsTable);
}
...
LPDISPATCH Worksheets::Add2(const VARIANT& Before, const VARIANT& After, const VARIANT& Count, const VARIANT& NewLayout)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
	InvokeHelper(0xbee, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms,
		&Before, &After, &Count, &NewLayout);
	return result;
}
