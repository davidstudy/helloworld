...
public:
	...
	LPDISPATCH GetAddIns2();
	BOOL GetPrintCommunication();
	void SetPrintCommunication(BOOL bNewValue);
	...
	BOOL GetUseClusterConnector();
	void SetUseClusterConnector(BOOL bNewValue);
	CString GetClusterConnector();
	void SetClusterConnector(LPCTSTR lpszNewValue);
	...
	long GetFileValidationPivot();
	void SetFileValidationPivot(long nNewValue);
	BOOL GetShowQuickAnalysis();
	void SetShowQuickAnalysis(BOOL bNewValue);
	LPDISPATCH GetQuickAnalysis();
	BOOL GetFlashFill();
	void SetFlashFill(BOOL bNewValue);
	BOOL GetEnableMacroAnimations();
	void SetEnableMacroAnimations(BOOL bNewValue);
	BOOL GetChartDataPointTrack();
	void SetChartDataPointTrack(BOOL bNewValue);
	BOOL GetFlashFillMode();
	void SetFlashFillMode(BOOL bNewValue);
	BOOL GetMergeInstances();
	void SetMergeInstances(BOOL bNewValue);
	BOOL GetEnableCheckFileExtensions();
	void SetEnableCheckFileExtensions(BOOL bNewValue);
};
/////////////////////////////////////////////////////////////////////////////
...
public:
	...
	LPDISPATCH GetSlicerCaches();
	LPDISPATCH GetActiveSlicer();
	VARIANT GetDefaultSlicerStyle();
	void SetDefaultSlicerStyle(const VARIANT& newValue);
	long GetAccuracyVersion();
	void SetAccuracyVersion(long nNewValue);
	BOOL GetCaseSensitive();
	BOOL GetUseWholeCellCriteria();
	BOOL GetUseWildcards();
	LPDISPATCH GetPivotTables();
	LPDISPATCH GetModel();
	BOOL GetChartDataPointTrack();
	void SetChartDataPointTrack(BOOL bNewValue);
	VARIANT GetDefaultTimelineStyle();
	void SetDefaultTimelineStyle(const VARIANT& newValue);
	LPDISPATCH GetQueries();
	void CreateForecastSheet(LPDISPATCH Timeline, LPDISPATCH Values, const VARIANT& ForecastStart, const VARIANT& ForecastEnd, const VARIANT& ConfInt, const VARIANT& Seasonality, const VARIANT& DataCompletion, const VARIANT& Aggregation, 
...
public:
	...
	LPDISPATCH GetSparklineGroups();
	void ClearHyperlinks();
	LPDISPATCH GetDisplayFormat();
	VARIANT BorderAround(const VARIANT& LineStyle, long Weight, long ColorIndex, const VARIANT& Color, const VARIANT& ThemeColor);
...
public:
	...
	void PrintOut(const VARIANT& From, const VARIANT& To, const VARIANT& Copies, const VARIANT& Preview, const VARIANT& ActivePrinter, const VARIANT& PrintToFile, const VARIANT& Collate, const VARIANT& PrToFileName, 
		const VARIANT& IgnorePrintAreas);
	LPDISPATCH Add2(const VARIANT& Before, const VARIANT& After, const VARIANT& Count, const VARIANT& NewLayout);
};
/////////////////////////////////////////////////////////////////////////////
// Font wrapper class
